...
int main(int argc, char *argv[]) {
    ...
    // Ring-based neighbor exchange using MPI_Sendrecv to avoid deadlock
    ...
    MPI_Sendrecv(&my_best_fitness, 1, MPI_INT, send_to, 0,
                 &neighbor_fitness, 1, MPI_INT, recv_from, 0,
                 MPI_COMM_WORLD, MPI_STATUS_IGNORE);

    MPI_Sendrecv(my_best_individual, (n+2)*(n+2), MPI_CHAR, send_to, 1,
                 neighbor_individual, (n+2)*(n+2), MPI_CHAR, recv_from, 1,
                 MPI_COMM_WORLD, MPI_STATUS_IGNORE);
